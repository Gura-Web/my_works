                ...
                <div class="content-container">
                    ...
                    <section class="me">
                        ...
                        <div data-aos="fade-up" data-aos-easing="ease" data-aos-duration="600">
                            <p class="me__desc">ECCコンピュータ専門学校でWEBデザインを学んでいます。<br>今年二年生になりました。<br>
                            持ち前の真面目さと積極性でWEB制作のアルバイトや勉強会に参加し、日々欠かさずデザインについて学んでいます。</p>
                            <ul class="contact">
                                ...
                                <li><a href="https://github.com/Gura-Web/my_works"><img src="<?= IMG_PATH ?>github.svg" alt="Twitter"></a></li>
                            </ul>
                        </div>
                ...
                <div class="content-container">
                    ...
                    <section class="other-experience" data-aos="fade-up" data-aos-easing="ease" data-aos-duration="900">
                        ...
                        <ul class="other-experience__list">
                            ...
                            <li data-aos="fade-up" data-aos-delay="700" data-aos-easing="ease" data-aos-duration="900">インターン<br>参加経験(4社)</li>
                        </ul>
                    </section>
                </div>
            ...
            <section class="policy">
                ...
                <div class="content-container">
                    ...
                    <section class="my-policy" data-aos="fade-up" data-aos-delay="400" data-aos-easing="ease" data-aos-duration="600">
                        ...
                        <p class="my-policy__desc">将来はWEB/UIデザイナーになりたいと考えています。</p>
                    </section>
                </div>
                <div class="square-wrapper" data-aos="fade-right" data-aos-delay="600" data-aos-easing="ease" data-aos-duration="1300">
