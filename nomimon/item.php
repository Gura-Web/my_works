    ...
    <div class="layout">
      <header id="js-header" class="header">
        <div class="header__container">
          <p class="back-btn"><a href="index.php"><img src="<?= imgPath ?>ico-arrow.svg" alt=""></a></p>
          <h1 class="current-pageName current-pageName--item"><img src="<?= imgPath ?>ico-stick__white.svg" alt=""><span>アイテム管理</span></h1>
        </div>
      </header>
      <div class="topWall">
          <div class="objects">
            <div id="js-character" class="character"><img src="<?= imgPath ?>character_rabbit_3.png" alt=""></div>
          ...
          <div class="itemContents">
            <ul class="itemContents__wrapper">
              <li data-item="accessory" class="itemContents__item js-itemContents__item">
                <span class="itemContents__img"></span>
