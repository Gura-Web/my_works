            ...
            <div id="section01" class="top-profile profile">
                    <div class="top-profile__wrapper">
                        ...
                        <section class="top-me">
                            ...
                            <p class="inview"><span class="inview__inner">2021年卒業予定 ２０歳</span></p>
                            <p class="top-me__desc inview"><span class="inview__inner">ECCコンピュータ専門学校 WEBデザイナー専攻2年<br> 兵庫県在住でデザインと格闘技見るのが好きです。</span></p>
                    ...
                    <dl class="data-dl">
                        ...
                        <dd class="inview">
                            <span class="inview__inner">
                                ...
                                最初の作品がオープンキャンパスの高校生向けに展示される<br>
                ...
                <section id="section04" class="skill">
                    ...
                    <ul class="skill-list slideup02">
                        ...
                        <li class="skill-list__item">Sketch<span class="skill-list__bar"><span class="skill-list__sketch"></span></span></li>
                        <li class="skill-list__item">HTML5 & CSS<span class="skill-list__bar"><span class="skill-list__html"></span></span></li>
                        <li class="skill-list__item">Sass<span class="skill-list__bar"><span class="skill-list__scss"></span></span></li>
                ...
                <section id="section05" class="activity">
                    ...
                    <dl class="data-dl">
                        ...
                        <dd>
                            ...
                            <!-- <dl class="data-dl__inner">
                                <dt class="inview"><span class="inview__inner">お絵描き</span></dt>
                                <dd class="inview"><span class="inview__inner">デザイナーには観察力とスケッチの力が必要と思い、週２日選択科目を取り絵を描いてます。また不定期で個人的にデッサン教室に通っています。ちなみに絵はすごい下手です。</span></dd>
                            </dl> -->
                        <dt>過去行なっていたこと</dt>
                        <dd>
                            <dl class="data-dl__inner">
                                <dt class="inview"><span class="inview__inner">Web制作のアルバイト</span></dt>
                                <dd class="inview"><span class="inview__inner">WEB制作会社にアルバイトに誘われ現在そこでデザイン/コーディング業務を行なっていました。<br>学校の都合をすごく考慮して頂いたり、技術的なことも教えていただけるのでとても感謝しています。</span></dd>
                            </dl>
                            <dl class="data-dl__inner">
                            ...
                            <dl class="data-dl__inner">
                                ...
                                <dd class="inview"><span class="inview__inner">現在は多忙で行っておりませんが、一時期はオープンキャンパスで高校生達に学校の説明や盛り上げを行なっていました。</span></dd>
                            </dl>
                    </dl>
                </section><!-- my-data -->
            </div><!-- main__container -->
