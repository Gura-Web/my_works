            ...
            <div class="main__container">
                ...
                <section id="section01" class="logo-desc">
                    <div class="logo-desc__wrapper">
                        ...
                        <!-- <p class="logo-desc__txt">UPDATEには2つの意味が込められています。</p> -->
                        ...
                        <div class="inview"><p class="logo-desc__desc inview__inner">
                            ...
                            私は長い間不登校児でしたが、インターネットに出会い居場所や学び、自分の価値を手に入れました。<br>
                            自分の人生を価値あるものにしてくれたこの大好きな分野で、人の生活を豊かにしていきたい。<br>
                            だから私はこの分野で常に学び、自身を更新し続けています。
                            <!-- これからさらに人々の生活を豊かにできる分野はWEB/ITだと信じています。<br>
                            私は長い間不登校児でしたが、インターネットに出会い<br>
                            居場所や学びを手に入れました。<br>
                            常に何かが更新され、可能性に溢れた空間は<br>
                            WEB/IT以外ではなく、興味を持たなかったでしょう。<br>
                            だから私はこの好きな分野で常に学び、自身を更新し続けています。 -->
                        </p></div>
                    </div>
                </section><!-- logo-desc -->
                <section id="section02" class="top-profile">
                    <div class="top-profile__wrapper">
                        ...
                        <section class="top-me">
                            ...
                            <div class="inview"><p class="top-me__desc inview__inner">ECCコンピュータ専門学校 WEBデザイナー専攻2年<br>2021年卒業予定 </p></div>
                            ...
                            <ul class="good-list">
                                <li class="good-list__item inview"><span class="inview__inner">・課題発見</span></li>
                                ...
                                <li class="good-list__item inview"><span class="inview__inner">・ディレクション</span></li>
